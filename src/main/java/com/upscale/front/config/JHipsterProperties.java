...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "frontend@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "frontend API";

        private String description = "frontend API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "frontend";
